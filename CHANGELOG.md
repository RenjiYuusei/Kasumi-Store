...
## [1.5.2] - 2026-02-17
### ⚡ Hiệu năng
- **Tối ưu Gson**: Tái sử dụng đối tượng `Gson` tĩnh khi tải danh sách ứng dụng thay vì cấp phát mới liên tục, giúp cải thiện tốc độ phân tích cú pháp khoảng 8 lần và giảm áp lực lên bộ dọn rác (Garbage Collector).
